...
CREATE TABLE templates (template_id VARCHAR(255) NOT NULL PRIMARY KEY, name VARCHAR(64) NOT NULL, api_type VARCHAR(255) NOT NULL, description VARCHAR(255), owner VARCHAR(255) NOT NULL, template MEDIUMTEXT NOT NULL);
