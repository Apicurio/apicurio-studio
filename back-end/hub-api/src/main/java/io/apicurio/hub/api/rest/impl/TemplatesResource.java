...
public class TemplatesResource implements ITemplatesResource {
    ...
    private static final List<ApiTemplate> allTemplates;

    static {
        final ObjectReader reader = new ObjectMapper().findAndRegisterModules().readerFor(Object.class);
        ...
        try {
            ...
            logger.error("Couldn't initialize static templates", e);
        } finally {
