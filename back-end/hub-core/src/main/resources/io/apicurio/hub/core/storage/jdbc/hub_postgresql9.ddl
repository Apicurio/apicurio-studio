...
CREATE TABLE api_content (design_id BIGINT NOT NULL, version BIGSERIAL NOT NULL, type SMALLINT NOT NULL, data TEXT NOT NULL, created_by VARCHAR(255) NOT NULL, created_on TIMESTAMP WITHOUT TIME ZONE NOT NULL, reverted SMALLINT DEFAULT 0 NOT NULL, modified_on TIMESTAMP);
