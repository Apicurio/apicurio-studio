...
This document introduces {studio}, explains how to install with your chosen storage option, and how to manage event schemas and API designs using the {studio} web console and REST API.
