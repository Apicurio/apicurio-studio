(function (global, factory) {
	...
	(factory((global.OAI_codegen = global.OAI_codegen || {}),global.OAI));
 ...
 */
var InterfacesVisitor = (function (_super) {
    ...
    InterfacesVisitor.prototype.visitPathItem = function (node) {
        ...
        if (split && split.length > 1) {
            ...
            if (firstSegment && firstSegment !== "" && firstSegment.indexOf("{") === -1) {
                var iname = this.capitalize(firstSegment);
 ...
 */
var PathItemDetectionVisitor = (function (_super) {
 ...
 */
var OpenApi2CodegenVisitor = (function (_super) {
