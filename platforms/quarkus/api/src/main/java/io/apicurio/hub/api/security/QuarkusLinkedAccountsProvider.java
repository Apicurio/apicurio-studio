...
@Alternative
@Priority(1)
public class QuarkusLinkedAccountsProvider implements ILinkedAccountsProvider {
	 ...
	 */
	@Override public InitiatedLinkedAccount initiateLinkedAccount(LinkedAccountType accountType,
