...
public interface GroupsResource {
  ...
  /**
   * Creates a new artifact by posting the artifact content.  The body of the request can
   * be the raw content of the artifact or a JSON object containing both the raw content and
   * a set of references to other artifacts.  The raw content is typically in JSON format for *most* of the 
