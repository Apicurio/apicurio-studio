...
export class ArtifactName extends PureComponent<ArtifactNameProps, ArtifactNameState> {
    ...
    public render(): React.ReactElement {
        return this.props.name ? (
            <React.Fragment>
                <span className="name" data-testid={this.testId("artifacts-lnk-view-")}>{this.props.name}</span>
                <span className="id" data-testid={this.testId("artifacts-lnk-view-id-")}>{this.props.id}</span>
            </React.Fragment>
        ) : (
            <React.Fragment>
                <span className="name" data-testid={this.testId("artifacts-lnk-view-")}>{this.props.id}</span>
            </React.Fragment>
        );
    }
